      ...
      listener: (context, state) {
        if (state is LibrarySuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Libro agregado a tu biblioteca')),
          );
                  ...
                  children: [
                    ...
                    Center(
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () {
                          final state = context.read<BookDetailBloc>().state;
                          if (state is BookDetailLoaded) {
                            ...
                            context
                                .read<LibraryBloc>()
                                .add(AddBookToLibrary(widget.bookId, bookData));
                          }
                        },
                      ),
                    ),
                    ...
                    BlocBuilder<ReviewBloc, ReviewState>(
                      builder: (context, state) {
                        if (state is ReviewLoading) {
                          ...
                          return Text(
                              'Error al cargar reseñas: ${state.message}');
                        } else {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => context
                          .read<BookDetailBloc>()
                          .add(FetchBookDetail(widget.bookId)),
